<template>
	<div class="title-card-wrap gradient-bg">
		...
		<div class="button-wrap">
			<button class="button" @click="toggleCard">Become a member</button>
		</div>
	</div>
	<div class="headline-card-wrap">
		...
		<div class="button-wrap">
			<button class="chip" @click="toggleCard">Add Topic</button>
	...
	<div class="card-wrap">
		<div>test</div>
		<!-- <name-card>test</name-card> -->
		<name-card :class="person.name === 'Kiyu'? 'highlight-content' :'content-wrap'" v-for="person in personList" :key="person" @findIndex="removeCard" :person="person"></name-card>
	</div>
	<!-------- Footer -------->
	<br /><br />
	<div class="title-card-wrap gradient-bg">
		<div class="title-wrap">
			<h2>🎖 111K followers</h2>
...
.gradient-bg {
	background-image: linear-gradient(109.6deg, rgb(13, 32, 134) 11.2%, rgba(144, 242, 255, 0.78) 100.2%);
	height: 8rem;
}
